...
def model_opts(parser):
    ...
    group.add('--encoder_type', '-encoder_type', type=str, default='rnn',
              choices=['graph', 'rnn', 'brnn', 'mean', 'transformer', 'cnn'],
              help="Type of encoder layer to use. Non-RNN layers "
                   "are experimental. Options are "
                   "[rnn|brnn|mean|transformer|cnn].")
    group.add('--gnn_type', '-gnn_type', type=str, default='ggnn',
              choices=['ggnn', 'gat', 'gin','gcn'],
              help="Type of graph encoder. Options are "
                   "[ggnn|gat|gim].")
    group.add('--gnn_layers', '-gnn_layers', type=int, default=5,
...
def preprocess_opts(parser):
    ...
    group.add('--train_node1', '-train_node1', required=True, nargs='+',
              help="Path to the training source data")
    group.add('--train_node2', '-train_node2', required=True, nargs='+',
              help="Path to the training source data")
